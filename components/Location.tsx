...
export const Location: React.FC = () => {
  ...
  return (
    <section id="location" className="py-20 bg-white" itemScope itemType="https://schema.org/LocalBusiness">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-dark mb-4" itemProp="name">{t.location.title}</h2>
               ...
               <div className="space-y-4">
                 <div className="flex items-start gap-4" itemProp="address" itemScope itemType="https://schema.org/PostalAddress">
                   ...
                   <div>
                     ...
                     <p className="text-gray-400" itemProp="streetAddress">{BUSINESS_INFO.address}</p>
